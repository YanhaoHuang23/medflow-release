...
def get_args_parser():
    ...
    parser.add_argument('--class-label', type=int, default=None, help='optional class filter for class-specific generators')
    ...
    parser.add_argument("--nb-code", type=int, nargs="+", default=[512], help="List of embedding sizes")
    parser.add_argument("--patch-num", type=int, nargs="+", default=[6], help="List of the number of patch")
    ...
    ## quantizer
    parser.add_argument("--quantizer", type=str, default='ema_reset', choices = ['ema', 'orig', 'ema_reset', 'reset', 'lfq', 'ema_reset_sim','ema_sim','reset_sim'], help="eps for optimal transport")
    ...
    parser.add_argument('--vq-eval-ds-repeats', default=3, type=int,
                        help='number of discriminative-score repeats during Stage-1 VQ evaluation; 0 skips DS')
